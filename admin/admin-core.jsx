...
const DEFAULTS = {
  ...
  schemes: {
    ...
    items: [
      { cap: 'Розташування на карті', src: '../assets/havan-satellite-2.jpg' },
      { cap: 'Детальна схема ділянок', src: '../assets/havan-genplan-2.jpg' },
    ],
  },
  infrastructure: {
  ...
  files: [
    { name: 'Генплан (супутник)', path: '../assets/havan-satellite-2.jpg' },
    { name: 'Детальна схема ділянок', path: '../assets/havan-genplan-2.jpg' },
    { name: 'Схема PDF', path: '../assets/havan-scheme.pdf' },
  ],
};
